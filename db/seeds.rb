...
course_student_relations = [{:course => 1, :student => 1}, {:course => 1, :student => 6}, 
                            {:course => 1, :student => 2}, {:course => 2, :student => 6}, 
                            {:course => 2, :student => 2}, {:course => 3, :student => 6}, 
                            {:course => 3, :student => 2}, {:course => 4, :student => 6}, 
                            {:course => 5, :student => 4}, {:course => 5, :student => 6}, 
                            {:course => 5, :student => 5}, {:course => 6, :student => 6}, 
                            {:course => 4, :student => 4},
                            {:course => 4, :student => 5},
                            {:course => 3, :student => 5},
    ]
