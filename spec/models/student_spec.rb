...
describe Student do
	...
	before :all do
		...
		Submission.create!(student_id: 100, problem_id: 100, complete: true, time_submitted: DateTime.parse("10 May 2016 10:59:59 PM Central Time (US & Canada) "), id: 101, result: '{"status":"success","err":"","results":[{"title":"main case","input":"testingbecauseican","result":"success","output":"testingbecauseican\n","err":""}]}')
		Submission.create!(student_id: 100, problem_id: 100, complete: false, time_submitted: DateTime.parse("1 May 2016 6:59:59 PM Central Time (US & Canada) "), id: 102, result: '{"status":"success","err":"","results":[{"title":"main case","input":"testingbecauseican","result":"success","output":"testingbecauseican\n","err":""}]}')
